...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 place-content-center py-20 px-20 grid lg:grid-cols-2 xl:grid-cols-3 gap-10 min-h-screen">
      <div className="bg-white flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="flex justify-between my-2 odd:bg-blue-50 even:bg-red-50 only:bg-red-500"
            >
        ...
        <div className="flex">
          <button className="mt-5 bg-blue-500 text-white p-2 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:text-red-500">
            Checkout
          </button>
        </div>
      </div>
